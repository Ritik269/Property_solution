...
namespace Findpropertymain.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public CustomerController(propertyslnContext context)
        {
            _context = context;
        }

        // GET: Helps to view the customer
        ...
        // GET: Helps to view the cistomer details
        ...
        // GET: helps to  create the customer
        ...
        // POST: Helps to post the customer details
        ...
        // GET: Helps to edit the customer details
        ...
        // POST: helps to post the edited customer details
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Helps to Delete the Customer details
        ...
        // POST: Delete the customer details
